...
# Get the swift directory, easier to do it absolute than relative
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
SWIFT_ROOT="$(dirname "$( dirname "$SCRIPT_DIR")")"
...
declare -A EXAMPLES=(
    [BalsaraKim]="examples/HydroTests/BalsaraKim"
    [BlobTest_3D]="examples/HydroTests/BlobTest_3D"
    [BlobTest_Braspenning2022]="examples/HydroTests/BlobTest_Braspenning2022"
    [Diffusion_1D]="examples/HydroTests/Diffusion_1D"
    [EvrardCollapse_3D]="examples/HydroTests/EvrardCollapse_3D"
    [Gradients]="examples/HydroTests/Gradients"
    [GreshoVortex_2D]="examples/HydroTests/GreshoVortex_2D"
    [GreshoVortex_3D]="examples/HydroTests/GreshoVortex_3D"
    [IdealizedAGNJet]="examples/HydroTests/IdealizedAGNJet"
    ...
    [KeplerianRing]="examples/HydroTests/KeplerianRing"
    [NFW_Hydrostatic]="examples/HydroTests/NFW_Hydrostatic"
    [Noh_1D]="examples/HydroTests/Noh_1D"
    [Noh_2D]="examples/HydroTests/Noh_2D"
    [Noh_3D]="examples/HydroTests/Noh_3D"
    [PerturbedBox_2D]="examples/HydroTests/PerturbedBox_2D"
    [PerturbedBox_3D]="examples/HydroTests/PerturbedBox_3D"
    [Rayleigh-Taylor_2D]="examples/HydroTests/Rayleigh-Taylor_2D"
    ...
    [SineWavePotential_1D]="examples/HydroTests/SineWavePotential_1D"
    [SineWavePotential_2D]="examples/HydroTests/SineWavePotential_2D"
    [SineWavePotential_3D]="examples/HydroTests/SineWavePotential_3D"
    ...
    [UniformBox_2D]="examples/HydroTests/UniformBox_2D"
    [UniformBox_3D]="examples/HydroTests/UniformBox_3D"
